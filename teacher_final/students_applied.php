              ...
              <tr>
                 ...
                 <td>
                    ...
                    <div class="btn-group">
                      ...
                      <a onClick="return confirm('Please confirm accepting the selected student for this internship...');" href="send_accept_mail.php?id=<?php echo $row['id'];?>" class="btn" style="background-color:#bf55ec; color:white;">ACCEPT</a>
