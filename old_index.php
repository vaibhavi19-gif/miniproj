                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-3 col-lg-3 d-none d-lg-block">
                                <div class="Appointment">
                                    ...
                                    <div class="phone_num d-none d-xl-block">
                                        <a href="signin1.php">Sign up</a>
                                    </div>
                                    <div class="d-none d-lg-block">
                                        <a class="boxed-btn3" href="#">Post/Find a Job</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-7 col-md-6">
                        <div class="slider_text">
                            ...
                            <p class="wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".4s">Your internship/job solution in your own campus!</p>
                            <div class="sldier_btn wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".5s">
                                <a href="#" class="boxed-btn3">Browse Jobs Near you</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="footer_widget wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s">
                            ...
                            <p>
                                kulkarni.sr@somaiya.edu <br>
                                vaibhavi.k@somaiya.edi<br>
                            </p>
